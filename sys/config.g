...
; Filament Sensor
; ===============
M591 D0 P1 C"e2stop" S1                                   ; filament monitor connected to power detector
...
M950 F0 C"fan2" Q100                                      ; create fan 0 on pin fan0 and set its frequency
M106 P0 S0 H-1 C"Motherboard Cooling"                            ; set fan 0 value. Thermostatic control is turned off
